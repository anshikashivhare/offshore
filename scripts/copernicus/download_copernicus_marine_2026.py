...
# ============================================================
# Copernicus Marine - 2026 Download
# ============================================================
...
# ------------------------------------------------------------
# Time range
# Copernicus dataset is currently available through 2026-06-23
# ------------------------------------------------------------
...
# Output file
# ------------------------------------------------------------
OUTPUT_FILE = OUTPUT_DIR / "copernicus_marine_2026.nc"


def main():
    print("=" * 60)
    print("Starting Copernicus Marine 2026 download")
    print("=" * 60)
