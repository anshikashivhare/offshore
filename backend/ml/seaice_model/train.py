...
Run: python -m ml.seaice_model.train
"""
...
def train_model(nc_path: str = None):
    if nc_path:
        ...
        from ml.seaice_model.real_data_loader import load_netcdf_to_dataframe
    ...
    model.save_model("ml/seaice_model/seaice_xgb.json")
    print("Model saved to ml/seaice_model/seaice_xgb.json")
